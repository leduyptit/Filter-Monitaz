...
public class NaiveBayesExample {
	...
	public static void main(String[] args) throws IOException {
		...
		trainingExamples.put("sub", readLines1("trainsub/sentiment.txt"));
		trainingExamples.put("non-sub", readLines1("trainsub/nosentiment.txt"));
		...
		BufferedReader in = new BufferedReader(new InputStreamReader(
				new FileInputStream("trainsub/test.txt"), "UTF-8"));
